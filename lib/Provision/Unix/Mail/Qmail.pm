package Provision::Unix::Mail::Qmail;
...
Perhaps a little code snippet.
    ...
    use Provision::Unix::Mail::Qmail;

    my $foo = Provision::Unix::Mail::Qmail->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Provision::Unix::Mail::Qmail
