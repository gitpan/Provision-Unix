package Provision::Unix::Mail::Sendmail;
...
Perhaps a little code snippet.
    ...
    use Provision::Unix::Mail::Sendmail;

    my $foo = Provision::Unix::Mail::Sendmail->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Provision::Unix::Mail::Sendmail
