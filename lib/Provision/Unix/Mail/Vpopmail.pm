package Provision::Unix::Mail::Vpopmail;
...
Perhaps a little code snippet.
    ...
    use Provision::Unix::Mail::Vpopmail;

    my $foo = Provision::Unix::Mail::Vpopmail->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Provision::Unix::Mail::Vpopmail
