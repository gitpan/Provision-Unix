package Provision::Unix::Mail::Zimbra;
...
Perhaps a little code snippet.
    ...
    use Provision::Unix::Mail::Zimbra;

    my $foo = Provision::Unix::Mail::Zimbra->new();
    ...
...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Provision::Unix::Mail::Zimbra
